...
char ssid = "Francis";//wifi ssid 
char password = "bananana";//wifi password
...
void main()
{
   ...
   // Lcd_Start();
    ...
    while(1)
    {
        if(IR==1) //checking the value of IR sensor for HIGH output 
        {
            char value1 = '5';//setting flag
