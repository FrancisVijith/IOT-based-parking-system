...
SOURCEFILES_QUOTED_IF_SPACED=work.c

# Object Files Quoted if spaced
OBJECTFILES_QUOTED_IF_SPACED=${OBJECTDIR}/work.p1
POSSIBLE_DEPFILES=${OBJECTDIR}/work.p1.d

# Object Files
OBJECTFILES=${OBJECTDIR}/work.p1
...
${OBJECTDIR}/work.p1: work.c  nbproject/Makefile-${CND_CONF}.mk
	@${MKDIR} "${OBJECTDIR}" 
	@${RM} ${OBJECTDIR}/work.p1.d 
	@${RM} ${OBJECTDIR}/work.p1 
	${MP_CC} $(MP_EXTRA_CC_PRE) -mcpu=$(MP_PROCESSOR_OPTION) -c  -D__DEBUG=1    -fno-short-double -fno-short-float -O0 -fasmfile -maddrqual=ignore -xassembler-with-cpp -mwarn=-3 -Wa,-a -DXPRJ_default=$(CND_CONF)  -msummary=-psect,-class,+mem,-hex,-file  -ginhx032 -Wl,--data-init -mno-keep-startup -mno-osccal -mno-resetbits -mno-save-resetbits -mno-download -mno-stackcall $(COMPARISON_BUILD)  -std=c99 -gdwarf-3 -mstack=compiled:auto:auto     -o ${OBJECTDIR}/work.p1 work.c 
	@-${MV} ${OBJECTDIR}/work.d ${OBJECTDIR}/work.p1.d 
	@${FIXDEPS} ${OBJECTDIR}/work.p1.d $(SILENT) -rsi ${MP_CC_DIR}../  
